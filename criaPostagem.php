      ...
      <form action="processaPostagem.php" method="POST" enctype="multipart/form-data" autocomplete="off">
        ...
        <div class="col s12 m6">
          ...
          <div class="file-field input-field">
            <div class="btn btnDefaultDark col s12">
              <span>Imagem</span>
              <input type="file" name="fotoPostagem" onchange="imagePreview(this)">
            </div>
        ...
        <div class="col s12 m6">
          <div class="input-field">
            <input type="text" name="tituloPostagem" placeholder="Título da postagem" />
          </div>
          <div class="input-field">
            <input type="text" name="subtituloPostagem" placeholder="Subtítulo da postagem" />
          </div>
          <div class="input-field">
            <?php
        ...
        <div class="col s12">
          <div class="input-field">
            <textarea name="textoPosta" class="conteudoPostagem"></textarea>
