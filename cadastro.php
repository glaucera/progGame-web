    ...
    <div class="row">
        <div class="col s12 m5 offset-m7 divForms">
            <form class="formCadastro" action="processaCadastro.php" method="post" enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="containerMargin">
                    ...
                    <div class="file-field input-field">
                        <div class="btn-flat center btnDefault btnBlock">
                            ...
                            <input type="file" onchange="imagePreview()" class="inputFoto" name="fotoCadastro">
                        </div>
                ...
                <div class="input-field">
                    <input name="nomeCadastro" type="text" placeholder="Nome completo" class="inputCadastro">
                </div>
                <div class="input-field">
                    <input name="loginCadastro" type="text" placeholder="Nickname" class="inputCadastro">
                </div>
                <div class="input-field">
                    <input name="senhaCadastro" type="password" placeholder="Senha" class="inputCadastro inputSenha" onkeyup="contagemCarac()">
